...
MyDir = os.chdir('G:\\ADM_TENSOR_FLOW')
#constants
root_dir = os.getcwd()
data_dir = root_dir + '\\data\\'
fruit_models_dir = root_dir + '\\fruit_models\\'
labels_file = 'G:\\ADM_TENSOR_FLOW\\utils\\labels'

# change this to the path of the folders that hold the images
training_images_dir = 'G:\\ADM_TENSOR_FLOW\\Training\\'
test_images_dir = 'G:\\ADM_TENSOR_FLOW\\Test\\'
...
tf.app.flags.DEFINE_string('train_directory', training_images_dir,
                           'Training data directory')

tf.app.flags.DEFINE_string('test_directory', test_images_dir,
                           'Test data directory')

tf.app.flags.DEFINE_string('output_directory', data_dir,
